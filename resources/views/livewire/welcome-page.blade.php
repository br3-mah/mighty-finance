                                            ...
                                            <div style="left: -14px;" class="input-group">
                                                ...
                                                <div class="slider">
                                                    ...
                                                    <label class="input-group">Email
                                                        <input required style="outline: none; border-top-style: hidden;border-right-style: hidden;border-left-style: hidden;background-color: #662d91;display: block;color: #fff;width: 100%;height: 1.5rem" type="text" id="email" name="email" placeholder="name@email.com">
                                                    </label>
                                                    </radio>
                                                    <radio>
                                                    <h4 class="text-white"></h4>
                    ...
                    <div class="wpb_wrapper ">
                        <div class="mb30">
                            ...
                            <div class="pdl120">
                                ...
                                <p><a type="button" data-toggle="modal" data-target="#exampleModalCenter2" class="btn-default-link" href="{{ route('contact') }}">Get in Touch</a></p>
                            </div>
                ...
                <div class="vc_column-inner ">
                    <div class="wpb_wrapper ">
                        ...
                        <div class="wpb_text_column wpb_content_element vc_custom_1531470973815">
                            <div class="wpb_wrapper">
                                <p><a class="mr20" href="#"><img class="alignnone size-full wp-image-1438" src="{{ asset('public/web/images/app-store-img.png') }}" alt="" width="170" height="50" /></a> <a class="mr20" href="#"><img class="alignnone size-medium wp-image-1439" src="{{ asset('public/web/images/google-play-img.png') }}" alt="" width="170" height="50" /></a> </p>
                            </div>
                        </div>
                    </div>
                </div>
