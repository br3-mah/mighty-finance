	...
	<section class="intro-style1-area" style="padding-top:10%; height:auto; background-repeat: no-repeat; background-attachment: fixed; background-image: url('{{ asset("/public/box/images/success-loan.jpg") }}'); background-size:cover; background-color: #7B1001; margin-top:0px; top:0;">
        <div class="container">
                                ...
                                <div class="col-xl-12 col-lg-12 position-relative " style="color: #7B1001;">
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        ...
                                        border: 1px solid rgba(255, 255, 255, 0.3);">
                                            ...
                                            to your account to view and track your loan
                                            </p>
                                        </div>
                                        <div class="">
