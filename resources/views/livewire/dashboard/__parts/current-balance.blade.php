        ...
        <div class="card" style="background-color: rgb(255, 208, 0)">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="card">
                        <button class="btn btn-light text-primary p-4" style="box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;"> 
...
<div class="col-xxl-4 col-xl-12">
    <div class="row">
        <div class="col-xxl-6 col-xl-6 col-lg-6">
            <div class="card" style="background-image: linear-gradient(to right, #662d91, rgb(139, 89, 177)); color:#fff">
                <div class="card-body">
                    <div class="row">
                        <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-6 col-sm-6">
                            ...
                            <div class="mt-2">
                                <a href="{{ route('new-loan') }}" style="background-color:#fff;" class="btn"> <strong>Get a Loan</strong> </a>
                            </div>
                        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6">
            <div class="card" style="background: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8UW4-kylyJg8bj33K3boAIvJ46HbT362BRwF06jStNxZLf2nkni-UDFofFkcvWrHhDqc&usqp=CAU'); 
                ...
                <!-- Purple Tint Overlay -->
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(102, 45, 145, 0.772);"></div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <div class="mt-3">
                                <button style="background-color:#fff; color:black; z-index:1; position:absolute" class="btn"> 
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <div class="mt-4">
                                <strong class="text-white" style="z-index:1; position:absolute">Refer a Friend</strong>
                            </div>
                        </div>
                    </div>
                </div>
