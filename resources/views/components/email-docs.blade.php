<div class="modal" id="sendDocModal">
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{route('share.docs')}}" method="POST" id="shareDocsForm" class="modal-content send-doc-modal">
            @csrf
            <!-- Modal Header -->
            <div class="modal-header bg-info justify-content-center text-center">
                ...
                <button type="button" onclick="closeSendDocModal()" class="close">&times;</button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" id="cancelShareDoc" onclick="closeSendDocModal()" class="btn btn-sm btn-light text-gray">Its okay, I already signed</button>
