            ...
            <tr>
              <td style="padding:40px 30px 30px 30px;text-align:center;font-size:1.5em;font-weight:bold;">
                <a href="http://dopplerhealth.com/" style="text-decoration:none;">
                  <img width="2170" alt="Mighty Finance" style="width:2170px;max-width:80%;height:auto;border:none;text-decoration:none;color:#750303;" src="https://bridgetrustfinance.co.zm/public/box/images/resources/logo-11.png">
                </a>
              </td>
            </tr>
            <!--      Intro Section -->
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                ...
                <p style="text-align: center;margin: 2.5em auto;">
                  <a class="button" href="{{ $actionUrl }}" style="background: #ffc400; 
                       text-decoration: none; 
                       padding: 1em 1.5em;
                       color: #ffffff; 
                       border-radius: 48px;
                       mso-padding-alt:0;
                       text-underline-color:#ffb192">
                    <!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%;mso-text-raise:20pt">&nbsp;</i><![endif]-->
                    <span style="mso-text-raise:10pt;font-weight:bold;">View More Details!</span>
                    <!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%">&nbsp;</i><![endif]-->
                  </a>
                </p>
                <p>Thank you for your time and for using Mighty Finance. Your feedback is invaluable to us.</p>
                <p>Thanks,</p>
                <p>The Mighty Finance Team</p>
              </td>
            </tr>
            <tr>
