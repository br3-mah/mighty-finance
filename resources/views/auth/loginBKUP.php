										...
										<form class="mt-4" method="POST" action="{{ route('login') }}">
										  ...
										  <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap"> 
											  <div class="form-check">
												...
												<label class="form-check-label font-w400" for="remember_me">keep me signed in</label>
											  </div>
											  @if (Route::has('password.request'))
											  	<span><a href="{{ route('password.request') }}" class="text-primary font-w500 c-pointer">Forget Password ?</a></span>
											  @endif
										 </div>
